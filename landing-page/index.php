...
<head>
    ...
    <title>CDM-IRS Landing Page</title>
    <link rel="stylesheet" href="../assets/css/cdm.css">
...
<body>
    ...
    <div class="navbar">
        ...
        <ul class="nav">
            ...
            <li><a href="https://github.com/zenryui/cdm-internship-system/tree/fullstack">Github Repository</a></li>
    ...
    <div class="container">
        ...
        <a href="../students/index.php" class="get-started">Get Started</a>
    </div>
</body>
</html>
